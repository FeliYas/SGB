...
class ContactoController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'mail_adm' => 'sometimes|nullable|email|max:255',
            'mail_ventas' => 'sometimes|nullable|email|max:255',
            'mail_tlk' => 'sometimes|nullable|email|max:255',
            'wp_adm' => 'sometimes|nullable|string|max:255',
            'wp_ventas' => 'sometimes|nullable|string|max:255',
            'wp_tlk' => 'sometimes|nullable|string|max:255',
