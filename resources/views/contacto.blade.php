...
@section('content')
    ...
    <div class="mx-auto flex w-full max-w-[1200px] flex-col gap-6 px-4 py-10 md:gap-10 md:px-0 md:py-20">
            ...
            <form id="contactForm" method="POST" action="{{ route('send.contact') }}"
                ...
                <div class="flex flex-col justify-end gap-3 ">
                    ...
                    <button form="contactForm" type="submit"
                        class="bg-primary-orange text-bold min-h-[41px] w-full text-[16px] text-white rounded-sm">Enviar
                        consulta</button>
                </div>
            </form>
        </div>
        ...
        <div class="mt-4 w-full">
            <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3289.762789830244!2d-58.702954999999996!3d-34.4581689!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bca24f9a25fef5%3A0x97043401924a6868!2sVDR%20-%20SR33%20Frenos%20%26%20Anticongelantes!5e0!3m2!1ses-419!2sar!4v1753799646685!5m2!1ses-419!2sar"
