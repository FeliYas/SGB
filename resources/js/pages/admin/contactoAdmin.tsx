...
export default function ContactoAdmin() {
    ...
    const { data, setData, post } = useForm({
        ...
        mail_adm: contacto?.mail_adm,
        mail_ventas: contacto?.mail_ventas,
        mail_tlk: contacto?.mail_tlk,
        wp_adm: contacto?.wp_adm,
        wp_ventas: contacto?.wp_ventas,
        wp_tlk: contacto?.wp_tlk,
    });
        ...
        <Dashboard>
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-6" action="">
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-8 max-sm:grid-cols-1">
                    <div className="col-span-2 grid w-full grid-cols-3 gap-6">
                        <div className="w-full">
                            <label htmlFor="username" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                                <FontAwesomeIcon color="#FF120B" icon={faEnvelope} size="lg" />
                                <p>Mail {'(Contacto)'}</p>
                            </label>
                            <div className="mt-2">
                    ...
                    <h2 className="border-primary-orange text-primary-orange text-bold col-span-2 w-full border-b-2 text-2xl">Administracion</h2>
                    <div className="">
                        <label htmlFor="wp_adm" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                            <FontAwesomeIcon icon={faSquareWhatsapp} size="xl" color="#FF120B" />
                            <p>WhatsApp</p>
                        </label>
                        <div className="mt-2">
                            <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2">
                                ...
                                <input
                                    value={data?.wp_adm}
                                    onChange={(ev) => {
                                        setData('wp_adm', ev.target.value);
                                    }}
                                    id="wp_adm"
                                    name="wp_adm"
                                    type="text"
                    ...
                    <div className="flex w-full flex-row gap-2">
                        <div className="w-full">
                            <label htmlFor="mail_adm" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                                <FontAwesomeIcon color="#FF120B" icon={faEnvelope} size="lg" />
                                <p>Mail </p>
                            </label>
                            <div className="mt-2">
                                <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2">
                                    ...
                                    <input
                                        value={data.mail_adm}
                                        onChange={(ev) => {
                                            setData('mail_adm', ev.target.value);
                                        }}
                                        id="mail_adm"
                                        name="mail_adm"
                                        type="text"
                    ...
                    <h2 className="border-primary-orange text-primary-orange text-bold col-span-2 w-full border-b-2 text-2xl">Ventas</h2>
                    <div className="">
                        <label htmlFor="wp_ventas" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                            <FontAwesomeIcon icon={faSquareWhatsapp} size="xl" color="#FF120B" />
                            <p>WhatsApp</p>
                        </label>
                        <div className="mt-2">
                            <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2">
                                <div className="shrink-0 text-base text-gray-500 select-none sm:text-sm/6"></div>
                                <input
                                    value={data?.wp_ventas}
                                    onChange={(ev) => {
                                        setData('wp_ventas', ev.target.value);
                                    }}
                                    id="wp_ventas"
                                    name="wp_ventas"
                                    type="text"
                    ...
                    <div className="flex w-full flex-row gap-2">
                        <div className="w-full">
                            <label htmlFor="mail_ventas" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                                <FontAwesomeIcon color="#FF120B" icon={faEnvelope} size="lg" />
                                <p>Mail </p>
                            </label>
                            <div className="mt-2">
                                <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2">
                                    <div className="shrink-0 text-base text-gray-500 select-none sm:text-sm/6"></div>
                                    <input
                                        value={data.mail_ventas}
                                        onChange={(ev) => {
                                            setData('mail_ventas', ev.target.value);
                                        }}
                                        id="mail_ventas"
                                        name="mail_ventas"
                                        type="text"
                    ...
                    <h2 className="border-primary-orange text-primary-orange text-bold col-span-2 w-full border-b-2 text-2xl">Telemarketing</h2>
                    <div className="">
                        <label htmlFor="wp_tlk" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                            <FontAwesomeIcon icon={faSquareWhatsapp} size="xl" color="#FF120B" />
                            <p>WhatsApp</p>
                        </label>
                        <div className="mt-2">
                            <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2">
                                ...
                                <input
                                    value={data?.wp_tlk}
                                    onChange={(ev) => {
                                        setData('wp_tlk', ev.target.value);
                                    }}
                                    id="wp_tlk"
                                    name="wp_tlk"
                                    type="text"
                    ...
                    <div className="flex w-full flex-row gap-2">
                        <div className="w-full">
                            <label htmlFor="mail_tlk" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                                <FontAwesomeIcon color="#FF120B" icon={faEnvelope} size="lg" />
                                <p>Mail </p>
                            </label>
                            <div className="mt-2">
                                <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2">
                                    ...
                                    <input
                                        value={data.mail_tlk}
                                        onChange={(ev) => {
                                            setData('mail_tlk', ev.target.value);
                                        }}
                                        id="mail_tlk"
                                        name="mail_tlk"
                                        type="text"
                        ...
                        <div className="flex flex-row gap-4">
                            <div className="w-full">
                                <label htmlFor="fb" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                                    <FontAwesomeIcon color="#FF120B" icon={faFacebook} size={'lg'} />
                                    <p>Facebook</p>
                                </label>
                                <div className="mt-2">
                                    <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2">
                        ...
                        <div className="flex flex-row gap-4">
                            <div className="w-full">
                                <label htmlFor="ig" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                                    <FontAwesomeIcon color="#FF120B" icon={faInstagramSquare} size={'lg'} />
                                    <p>Instagram</p>
                                </label>
                                <div className="mt-2">
                                    <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2">
                    ...
                    <div className="flex flex-row gap-4">
                        <div className="w-full">
                            <label htmlFor="telefono" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                                <FontAwesomeIcon color="#FF120B" icon={faPhone} size={'lg'} />
                                <p>Telefono</p>
                            </label>
                            <div className="mt-2">
                                <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2">
                    ...
                    <div className="flex flex-row gap-4">
                        <div className="w-full">
                            <label htmlFor="location" className="flex flex-row items-center gap-2 text-sm/6 font-medium text-gray-900">
                                <FontAwesomeIcon color="#FF120B" icon={faLocationDot} size={'lg'} />
                                <p>Ubicacion</p>
                            </label>
                            <div className="mt-2">
                                <div className="focus-within:outline-primary-orange flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 outline-gray-300 focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2">
